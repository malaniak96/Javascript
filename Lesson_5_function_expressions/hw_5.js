...
console.log('The area of the circle is: ', circleArea(9));
...
scheduleJS(['lesson: js', 'dates: august 1 - september 8', 'okten school', 2023]);
...
//- створити функцію яка повертає найменьше число з масиву
    let arr = [2, 7, 5, 9, 1, 5, 6, 71, 0.01, 25, 0.2];
    let minNumber = (array2) => {
        let min = array2[0];
